...
class User extends \Newscoop\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'email', 'username', 'password', 'first_name', 'last_name', 'created', 'updated', 'lastLogin', 'status', 'is_admin', 'is_public', 'points', 'image', 'role', 'groups', 'attributes', 'commenters', 'resetToken', 'subscriber', 'author', 'indexed', 'identities', 'publication', 'street', 'postal', 'city', 'phone', 'state', 'countryCode', 'clients', 'topics');
        }

        return array('__isInitialized__', 'id', 'email', 'username', 'password', 'first_name', 'last_name', 'created', 'updated', 'lastLogin', 'status', 'is_admin', 'is_public', 'points', 'role', 'groups', 'attributes', 'commenters', 'resetToken', 'subscriber', 'author', 'indexed', 'identities', 'publication', 'street', 'postal', 'city', 'phone', 'state', 'countryCode', 'clients', 'topics');
    }
