 ...
 */
class ArticlePackage extends \Newscoop\Package\ArticlePackage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'article', 'package');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArticlePackage $proxy) {
