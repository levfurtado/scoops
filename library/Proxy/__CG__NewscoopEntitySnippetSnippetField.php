 ...
 */
class SnippetField extends \Newscoop\Entity\Snippet\SnippetField implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'snippet', 'templateField', 'data', 'fieldName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SnippetField $proxy) {
    ...
    public function getFieldScope()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFieldScope', array());

        return parent::getFieldScope();
    }
    ...
    public function getTemplateField()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTemplateField', array());

        return parent::getTemplateField();
    }

    /**
     * {@inheritDoc}
     */
    public function setTemplateField(\Newscoop\Entity\Snippet\SnippetTemplate\SnippetTemplateField $templateField)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTemplateField', array($templateField));

        return parent::setTemplateField($templateField);
    }
