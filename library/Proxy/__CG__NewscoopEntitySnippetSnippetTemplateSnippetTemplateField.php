...
namespace Proxy\__CG__\Newscoop\Entity\Snippet\SnippetTemplate;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class SnippetTemplateField extends \Newscoop\Entity\Snippet\SnippetTemplate\SnippetTemplateField implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'templateFieldName', 'type', 'scope', 'required', 'template');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SnippetTemplateField $proxy) {
    ...
    public function setName($templateFieldName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setName', array($templateFieldName));

        return parent::setName($templateFieldName);
    }
