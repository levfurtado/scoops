 ...
 */
class AuthCode extends \Newscoop\GimmeBundle\Entity\AuthCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'client', 'publication', 'user', 'redirectUri', 'token', 'expiresAt', 'scope');
        }
