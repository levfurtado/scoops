 ...
 */
class Session extends \Newscoop\Entity\Session implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'start_time', 'user_id', 'requests');
        }
    ...
    public function addRequest(\Newscoop\Entity\Request $request)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRequest', array($request));
