 ...
 */
class SystemPreferences extends \Newscoop\NewscoopBundle\Entity\SystemPreferences implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'option', 'value', 'created_at');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SystemPreferences $proxy) {
