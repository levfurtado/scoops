...
class Issue extends \Newscoop\Entity\Issue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'publication', 'number', 'language', 'name', 'workflowStatus', 'sections', 'template', 'sectionTemplate', 'articleTemplate', 'shortName', 'outputSettingsIssues');
        }
    ...
    public function setSectionTemplate(\Newscoop\Entity\Template $template)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSectionTemplate', array($template));
    ...
    public function getWorkflowStatus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWorkflowStatus', array());
