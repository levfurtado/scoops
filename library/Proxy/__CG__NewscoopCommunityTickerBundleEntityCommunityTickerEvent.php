...
namespace Proxy\__CG__\Newscoop\CommunityTickerBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CommunityTickerEvent extends \Newscoop\CommunityTickerBundle\Entity\CommunityTickerEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'event', 'params', 'created', 'user', 'is_active');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CommunityTickerEvent $proxy) {
