...
class Issue extends \Newscoop\Subscription\Issue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'subscription', 'issueNumber', 'issue', 'language', 'startDate', 'days', 'paidDays', 'noticeSent');
        }
    ...
    public function getIssueNumber()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIssueNumber', array());
