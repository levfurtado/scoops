 ...
 */
class CityLocations extends \Newscoop\NewscoopBundle\Entity\CityLocations implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'position', 'city_type', 'population', 'elevation', 'time_zone');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CityLocations $proxy) {
    ...
    public function setCityType($city_type)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCityType', array($city_type));

        return parent::setCityType($city_type);
    }

    /**
     * {@inheritDoc}
     */
    public function setPosition(\Newscoop\NewscoopBundle\ORM\Point $position)
    {
    ...
    public function setTimeZone($time_zone)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTimeZone', array($time_zone));
