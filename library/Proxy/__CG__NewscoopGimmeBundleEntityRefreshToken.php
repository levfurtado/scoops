 ...
 */
class RefreshToken extends \Newscoop\GimmeBundle\Entity\RefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'client', 'publication', 'user', 'token', 'expiresAt', 'scope');
        }
