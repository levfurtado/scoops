...
class ArticleImage extends \Newscoop\Image\ArticleImage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'articleNumber', 'image', 'number', 'isDefault', 'captions');
        }
     ...
     * {@inheritDoc}
     */
    public function setCaption($caption, \Newscoop\Entity\Language $language)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCaption', array($caption, $language));

        return parent::setCaption($caption, $language);
    }
    ...
    public function getCaption($languageId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCaption', array($languageId));

        return parent::getCaption($languageId);
    }
