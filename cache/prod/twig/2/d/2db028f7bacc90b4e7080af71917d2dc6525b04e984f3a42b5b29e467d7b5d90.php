...
class __TwigTemplate_2db028f7bacc90b4e7080af71917d2dc6525b04e984f3a42b5b29e467d7b5d90 extends Twig_Template
{
...
<head>
    ...
    ";
        // line 36
        if (((isset($context["localeFromCookie"]) ? $context["localeFromCookie"] : null) != "en")) {
            // line 37
            echo "    <script src=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["Newscoop"]) ? $context["Newscoop"] : null), "WEBSITE_URL", array(), "array"), "html", null, true);
    ...
    var g_security_token = '";
        // line 44
        echo twig_escape_filter($this->env, (isset($context["SecurityToken"]) ? $context["SecurityToken"] : null), "html", null, true);
        echo "';
    var g_admin_img = '";
        // line 45
    ...
    ";
        // line 75
        if (strpos($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "server", array()), "get", array(0 => "HTTP_REFERER"), "method"), "login.php")) {
            // line 76
    ...
    <script type=\"text/javascript\">
      ...
      ";
        // line 119
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "session", array()), "has", array(0 => "camp_user_msgs"), "method")) {
            // line 120
            echo "      user_msgs = \"";
            echo twig_escape_filter($this->env, strtr($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "session", array()), "get", array(0 => "camp_user_msgs"), "method"), 0, array(), "array"), "msg", array(), "array"), array("\"" => "'")), "html", null, true);
            echo "\";
      ";
            // line 121
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "session", array()), "set", array(0 => "camp_user_msgs", 1 => array()), "method"), "html", null, true);
            echo "
      ";
        }
        // line 123
...
";
    ...
    public function block_admin_page_menu_bar($context, array $blocks = array())
    {
        ...
        // line 129
        $context["breadcrumbsMenuArray"] = $this->env->getExtension('newscoop_extension')->getBreadcrumbsArray((isset($context["breadcrumbsMenu"]) ? $context["breadcrumbsMenu"] : null));
        // line 130
        if ((twig_length_filter($this->env, (isset($context["breadcrumbsMenuArray"]) ? $context["breadcrumbsMenuArray"] : null)) > 1)) {
            // line 131
            echo "    <div class=\"row\">
        <ol class=\"breadcrumb\">
        ";
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["breadcrumbsMenuArray"]) ? $context["breadcrumbsMenuArray"] : null));
            $context['loop'] = array(
...
";
    ...
    <a href=\"http://newscoop.sourcefabric.org/\" target=\"_blank\">";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["NewscoopVersion"]) ? $context["NewscoopVersion"] : null), "getRelease", array(), "method"), "html", null, true);
        echo "
    <br />
    &copy; ";
        // line 161
